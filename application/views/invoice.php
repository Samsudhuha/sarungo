				                ...
				                <ul>
									...
									<?php } else { ?>
				                        ...
				                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" >
											...
											<span class="badge badge-bg-1"><?php echo count($transactions) ?></span>
				                        </a>
				                        <ul class="dropdown-menu cart-list s-cate">
											<?php for ($i=0; $i < count($transactions); $i++) { ?>
												<li class="single-cart-list">
													<div class="cart-list-txt">
														<h6><?php echo $transactions[$i]->name ?></h6>
														<p><?php echo $transactions[$i]->total ?> x - <span class="price">$<?php echo $transactions[$i]->price ?></span></p>
													</div><!--/.cart-list-txt-->
													<div class="cart-close">
														<a href="<?php echo base_url('transaction/deleteProductTransaction/' . $transactions[$i]->id) ?>"><span class="lnr lnr-cross"></span></a>
													</div><!--/.cart-close-->
												</li><!--/.single-cart-list -->
											<?php } ?>
				                            <li class="total">
				                	...
				                	<li>
				                		<a href="#"><?php echo $this->session->user['name'] ?></a>
				                	</li>
				                	<li>
		...
		<section id="new-arrivals" class="new-arrivals">
			<div class="container">
				...
				<div class="new-arrivals-content">
					<div class="row">
						<?php for ($i=0; $i < count($arrivals); $i++) { ?>
							<div class="col-md-3 col-sm-4">
								<div class="single-new-arrival">
									<div class="single-new-arrival-bg">
										<img src="<?php echo base_url('image/' . $arrivals[$i]->image); ?>" alt="new-arrivals images">
										<div class="single-new-arrival-bg-overlay"></div>
										<?php if($this->session->user) { ?>
										<div class="new-arrival-cart">
											<p>
												<span class="lnr lnr-cart"></span>
												<a href="<?php echo base_url('transaction/addToCart/' . $arrivals[$i]->id); ?>">add <span>to </span> cart</a>
											</p>
										</div>
										<?php }?>
									</div>
									<h4><?php echo $arrivals[$i]->name ?></h4>
									<p class="arrival-product-price">$<?php echo $arrivals[$i]->price ?></p>
								</div>
							</div>
						<?php } ?>
					</div>
		...
		<section id="feature" class="feature">
			<div class="container">
				...
				<div class="feature-content">
					<div class="row">
						<?php for ($i=0; $i < count($featureds); $i++) { ?>
							<div class="col-md-3 col-sm-4">
								<div class="single-new-arrival">
									<div class="single-new-arrival-bg">
										<img src="<?php echo base_url('image/' . $featureds[$i]->image); ?>" alt="new-arrivals images">
										<div class="single-new-arrival-bg-overlay"></div>
										<?php if($this->session->user) { ?>
										<div class="new-arrival-cart">
											<p>
									...
									<h4><?php echo $featureds[$i]->name ?></h4>
									<p class="arrival-product-price">$<?php echo $featureds[$i]->price ?></p>
								</div>
							</div>
						<?php } ?>
					</div>
